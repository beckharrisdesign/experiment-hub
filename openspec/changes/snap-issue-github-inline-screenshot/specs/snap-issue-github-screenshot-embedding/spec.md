...
- **Job:** After capture and submit, the new issue shows the screenshot inline (GitHub-hosted) while the PNG still saves locally.
- **Done when:** A successful submit yields a rendered image in the issue record and a `snap-issue-*.png` in Downloads.
- **Not doing:** Third-party image hosts as primary; replacing local save; large crop UX redesign.
