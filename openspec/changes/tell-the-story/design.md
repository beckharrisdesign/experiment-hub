...
| Breakpoints      | S · 480px / L · 1024px (BHD Content Types). At S the 88px gutter may collapse to a stacked date-over-sentence; keep the mono/tabular date. See `.cursor/rules/design-guidelines.mdc`.                                                                                                                                                                          |
