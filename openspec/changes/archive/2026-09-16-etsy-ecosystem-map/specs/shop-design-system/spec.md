# Spec: shop-design-system

## Outcomes

See `proposal.md` Outcomes — the W&H standards layer codified from fragments so both a human and, later, the evaluation rubric can check work against it; MVDS as the base plus Etsy-specific extensions.
