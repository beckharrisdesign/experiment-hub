...
> **Completed & archived 2026-07-20.** Code shipped via merged PR #303 and design approved 2026-07-17. The remaining manual/post-deploy items (§2.1 `Public=Yes` backfill, §2.2 Notion copy fixes, §4.1 manual walkthrough, §1.2/§1.9/§4.3 live-page verification) were completed and verified by the founder (confirmed 2026-07-20); checkboxes below flipped to done at archive time.

## 1. User outcomes (from spec scenarios)

- [x] 1.1 Private row is hidden from public routes
- [x] 1.2 Backfilled public rows still render *(code reads `Public`; verify after the §2.1 backfill)*
...
- [x] 4.3 Post-deploy live-page verification of the copy fixes: `/experiments/best-day-ever` contains "got to be a better way"; `/experiments/mvds` contains "a minimally viable"; homepage hero has no `--`. (→ 1.9)
