...
See `../../proposal.md` — move between the vector artwork and the
machine-file stitch view of the same design; brushes are the machine
proofing hand-style stitching, within industry standards.
