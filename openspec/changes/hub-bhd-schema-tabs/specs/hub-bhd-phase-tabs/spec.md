...
- **Done when:** BHD-linked detail shows one tab per non-empty phase file; default tab is current phase; legacy PRD/Business Case tabs only when those files have content
- **Not doing:** In-browser BHD editing; replacing PRD track; hero/nav redesign
