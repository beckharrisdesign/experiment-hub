...
- [x] 1.3 Dev server starts with working credentials
      - Walkthrough-confirmed 2026-08-17: fresh terminal, `pnpm dev`, preflight silent, labs UI up. Credential exercise covered by §4.3's end-to-end OpenAI test against the resolved reference.
