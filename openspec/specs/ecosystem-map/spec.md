...
Keep every surface that produces a W&H component or listing — design, files, registries, authorship, publishing, sync, intelligence, evaluation, sweeps — held in one legible, governed picture, on a FigJam board and in prose that agree.

## Outcomes

See [proposal.md](../../changes/archive/2026-09-16-etsy-ecosystem-map/proposal.md) Outcomes — Katy holds the whole Etsy ecosystem in one legible, governed picture; done when the map is a spec'd capability with named seams and homes for the fragment layers; explicitly not product strategy or new tooling.
