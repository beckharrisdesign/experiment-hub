...
Define Simple Seed Organizer seed packet CRUD, canonical/custom field management, packet fact vs user note separation, and user annotations to printed packet instructions.
