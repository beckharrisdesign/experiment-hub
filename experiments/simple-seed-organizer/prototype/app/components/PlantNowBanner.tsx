  ...
  return (
    <div className="rounded-xl bg-[#f0fdf4] border border-[#bbf7d0] p-4 mb-4 relative">
      ...
      <div className="flex items-center gap-2 mb-3 pr-6">
        <svg className="w-4 h-4 text-[#16a34a] shrink-0" fill="currentColor" viewBox="0 0 24 24">
        ...
        <span className="text-sm font-semibold text-[#166534]">Plant this week</span>
      </div>

      <div className="space-y-1.5">
        {nowGroups.map(group => (
          <div key={group.action} className="flex items-baseline gap-2 text-sm">
            <span className="font-medium text-[#166534] shrink-0">{group.label}:</span>
