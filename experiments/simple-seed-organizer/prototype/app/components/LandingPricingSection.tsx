      ...
      <div className="max-w-[840px] mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Start free, stay free as long as you like, and upgrade to one simple
            plan when your collection outgrows it.
          </p>
        </div>

        <div className="grid md:grid-cols-2 gap-6 lg:gap-8">
          {/* Stash Starter — Figma `7:93`. Copy SSOT: shipped prototype; Figma text `7:111` aligned pass 3. */}
