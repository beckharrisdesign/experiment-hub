          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="text-center">
              ...
              <p className="text-[#4a5565] text-sm">
                Add seeds in seconds. Just name, variety, and source. Add
            ...
            <div className="text-center">
              ...
              <p className="text-[#4a5565] text-sm">
                See which seeds are expiring soon, so you use them before they
                go bad.
              </p>
            </div>
          </div>
        ...
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-[#4a5565] text-sm">
                Can&apos;t remember what you own, so you buy the same seeds
                again.
              </p>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
              ...
              <p className="text-[#4a5565] text-sm">
                Don&apos;t know which are still viable, so old packets go
                unused.
              </p>
            </div>
          </div>
