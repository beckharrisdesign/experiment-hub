...
export default function SeedDetailPage() {
  ...
  if (error || !seed) {
    return (
      <div className="min-h-screen bg-[#f3f4f6] flex flex-col items-center justify-center pt-[72px] px-4">
  ...
  const confirmDelete = async () => {
    ...
    try {
      ...
      toast.error(
        "I'm having trouble deleting that seed right now. Please try again in a moment.",
      );
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50">
          <div className="bg-white rounded-2xl shadow-xl p-6 max-w-sm w-full">
            ...
            <p className="text-sm text-[#6a7282] mb-6">
              &ldquo;{seed.name}&rdquo; will be permanently removed from your
              collection.
            </p>
