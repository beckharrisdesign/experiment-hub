...
// Base URL: from config.js (set at build time on Vercel via HUB_API_URL) or same-origin when empty.
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  form.addEventListener('submit', async function (e) {
    ...
    try {
      const response = await fetch((API_BASE || '') + '/api/landing-submission', {
        method: 'POST',
