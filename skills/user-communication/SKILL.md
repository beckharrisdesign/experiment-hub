...
description: >-
  Audits user-facing copy in a frontend codebase against content design standards
  (errors, labels, empty states, confirmations, microcopy). Use when reviewing UX
  writing or before release.
---
